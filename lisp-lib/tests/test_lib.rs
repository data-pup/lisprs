...
fn integer_addition_examples_with_nested_expressions() {
    NESTED_EXPR_INTEGER_ADDITION_TEST_CASES.iter().for_each(run_test);
}
...
static BASIC_INTEGER_ADDITION_TEST_CASES: &[TestCase] = &[
    ...
    TestCase { input: "(+ 1 1)", expected: "2", },
    TestCase { input: "((+ 1 1))", expected: "2", },
    TestCase { input: "(+ 1 1 1)", expected: "3", },
    TestCase { input: "+ 1 2", expected: "3", },
    TestCase { input: "(+ 10 10 10 10 10)", expected: "50", },
];

static NESTED_EXPR_INTEGER_ADDITION_TEST_CASES: &[TestCase] = &[
    TestCase { input: "(+ (+ 1 1) 1 1", expected: "4", },
    // TestCase { input: "(+ (+ 1 ))", expected: "1", },
